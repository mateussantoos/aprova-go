...
export const Button = ({
  ...
  const variants = {
    primary:
      "border-b-4 border-primary-dark bg-primary text-white hover:brightness-95 active:translate-y-1 active:border-b-0 disabled:border-b-0 disabled:bg-gray-300 disabled:text-gray-500",
    secondary:
      "border-b-4 border-secondary-dark bg-secondary text-white hover:brightness-95 active:translate-y-1 active:border-b-0 disabled:border-b-0 disabled:bg-gray-300 disabled:text-gray-500",
    terciary:
